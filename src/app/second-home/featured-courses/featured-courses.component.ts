  ...
  lectures = [
    {
      ...
      description: "This course provides an in-depth understanding of how the internet operates, covering topics such as data transmission, protocols, and network architecture.",
      price: 4000,
