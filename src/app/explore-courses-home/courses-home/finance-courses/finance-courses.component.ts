...
@Component({
  selector: 'app-finance-courses',
  imports: [FormsModule,CommonModule,NavbarComponent,CoursesHomeComponent,TranslocoPipe],
  templateUrl: './finance-courses.component.html',
  styleUrl: './finance-courses.component.css'
})
export class FinanceCoursesComponent implements OnInit{
