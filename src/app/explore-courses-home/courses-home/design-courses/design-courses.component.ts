...
@Component({
  selector: 'app-design-courses',
  imports: [NavbarComponent, CoursesHomeComponent,FormsModule,CommonModule,TranslocoPipe],
  templateUrl: './design-courses.component.html',
  styleUrl: './design-courses.component.css'
})
export class DesignCoursesComponent implements OnInit{
